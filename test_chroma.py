...
def create_vectordb(location,embedding,chunk_size=1200,chunk_overlap=200):
...
# vectordb=create_vectordb(location,embeddings,chunk_size=1200,chunk_overlap=200)
# #print(vectordb)
